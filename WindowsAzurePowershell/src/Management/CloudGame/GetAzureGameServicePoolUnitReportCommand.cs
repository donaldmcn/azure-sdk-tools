...
namespace Microsoft.WindowsAzure.Management.CloudGame
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "AzureGameServicePoolUnitReport"), OutputType(typeof(ServicePoolData))]
    public class GetAzureGameServicePoolUnitReportCommand : AzureCloudGameHttpClientCommandBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            ServicePoolData result = null;

            CatchAggregatedExceptionFlattenAndRethrow(() => { result = CloudGameClient.GetGameServicepoolsReport(CloudGameId).Result; });
            WriteObject(result);
        }
    }
}