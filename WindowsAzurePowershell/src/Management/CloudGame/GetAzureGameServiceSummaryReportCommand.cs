...
namespace Microsoft.WindowsAzure.Management.CloudGame
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "AzureGameServiceSummaryReport"), OutputType(typeof(DashboardSummary))]
    public class GetAzureGameServiceSummaryReportCommand : AzureCloudGameHttpClientCommandBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            CatchAggregatedExceptionFlattenAndRethrow(() => { result = CloudGameClient.GetGameServiceSummaryReport(CloudGameId).Result; });
            WriteObject(result);
        }
    }
}