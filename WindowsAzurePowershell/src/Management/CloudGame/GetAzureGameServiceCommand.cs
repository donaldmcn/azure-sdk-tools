...
namespace Microsoft.WindowsAzure.Management.CloudGame
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "AzureGameService"), OutputType(typeof(CloudGamesList))]
    public class GetGameServiceCommand : AzureCloudGameHttpClientCommandBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            CloudGamesList result = null;

            CatchAggregatedExceptionFlattenAndRethrow(() => { result = CloudGameClient.GetGameService().Result; });
            WriteObject(result);
        }
    }
}