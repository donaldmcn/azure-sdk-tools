...
namespace Microsoft.WindowsAzure.Management.CloudGame
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "AzureGameServiceDeploymentReport"), OutputType(typeof(ServiceDeploymentData))]
    public class GetAzureGameServiceDeploymentReportCommand : AzureCloudGameHttpClientCommandBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            ServiceDeploymentData result = null;

            CatchAggregatedExceptionFlattenAndRethrow(() => { result = CloudGameClient.GetGameServiceDeploymentsReport(CloudGameId).Result; });
            WriteObject(result);
        }
    }
}