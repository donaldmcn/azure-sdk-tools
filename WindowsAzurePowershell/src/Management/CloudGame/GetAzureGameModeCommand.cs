...
{
    /// <summary>
    /// Get the cloud game mode.
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "AzureGameMode"), OutputType(typeof(GameModeCollectionResponse))]
    public class GetAzureGameModeCommand : AzureCloudGameHttpClientCommandBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            GameModeCollectionResponse result = null;

            CatchAggregatedExceptionFlattenAndRethrow(() => { result = CloudGameClient.GetGameModes(CloudGameId).Result; });
            WriteObject(result);
        }
    }
}