...
namespace Microsoft.WindowsAzure.Management.CloudGame
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.Remove, "AzureGameCertificate"), OutputType(typeof(bool))]
    public class RemoveAzureGameCertificateCommand : AzureCloudGameHttpClientCommandBase
    {
        ...
        [Parameter(Mandatory = true, ValueFromPipelineByPropertyName = true, HelpMessage = "The cloud game certificate id.")]
        [ValidateNotNullOrEmpty]
        public System.Guid CertificateId { get; set; }

        [Parameter(HelpMessage = "Do not confirm deletion of game certificate.")]
        ...
        public override void ExecuteCmdlet()
        {
            ConfirmAction(Force.IsPresent,
                          ...
                          () =>
                          {
                              ...
                              CatchAggregatedExceptionFlattenAndRethrow(() => { result = CloudGameClient.RemoveGameCertificate(CloudGameId, CertificateId).Result; });
                              WriteObject(result);
                          });
        }
    }
