...
namespace Microsoft.WindowsAzure.Management.CloudGame
{
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.Get, "AzureGameCertificate"), OutputType(typeof(CloudGameCertificateCollectionResponse))]
    public class GetAzureGameCertificateCommand : AzureCloudGameHttpClientCommandBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            CloudGameCertificateCollectionResponse result = null;

            CatchAggregatedExceptionFlattenAndRethrow(() => { result = CloudGameClient.GetGameCertificates(CloudGameId).Result; });
            WriteObject(result);
        }
    }
}