...
namespace Microsoft.WindowsAzure.Management.CloudGame
{
    ...
    /// </summary>
    [Cmdlet("Publish", "AzureGameService"), OutputType(typeof(Microsoft.WindowsAzure.Management.Utilities.CloudGame.Contract.CloudService))]
    public class PublishGameServiceCommand : AzureCloudGameHttpClientCommandBase
    {
        ...
        public override void ExecuteCmdlet()
        {
            ...
            CatchAggregatedExceptionFlattenAndRethrow(() => { result = CloudGameClient.PublishCloudGameAsync(CloudGameId).Result; });
            WriteObject(result);
        }
    }
}